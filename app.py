...
from receipt_analyzer import (parse_receipt_to_structured_data, analyze_spending, 
                              generate_financial_advice, detect_anomalies)
...
def main():
    ...
    with st.sidebar:
        ...
        if not st.session_state.logged_in:
            ...
            page = st.radio("Go to", ["Dashboard", "Receipt Analyzer", "Advanced Receipt Analysis", "Analytics", "History", "Batch Process"])
    ...
    if page == "Login":
        ...
        if st.session_state.logged_in:
            ...
            st.warning("Please login")
    elif page == "Advanced Receipt Analysis":
        if st.session_state.logged_in:
            show_advanced_receipt_analysis()
        else:
            st.warning("Please login")
    elif page == "Analytics":
        if st.session_state.logged_in:
